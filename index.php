...
<head>
    ...
    <meta name="description" content="Aplikasi Pengelolaan Data Mahasiswa Jurusan Elektro dengan PHP, MySQLi, dan Bootstrap 4">
    <meta name="keywords" content="Aplikasi Pengelolaan Data Mahasiswa Jurusan Elektro dengan PHP, MySQLi, dan Bootstrap 4">
    <meta name="author" content="Robinson Wadu">
    ...
    <!-- title -->
    <title>Data Mahasiswa Jurusan Elektro</title>
</head>
<body>
    <div class="container-fluid">
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-user title-icon"></i> Data Mahasiswa Jurusan Elektro</h5>
    ...
    <div class="container-fluid">
        <?php if ($isAdmin): ?>
            <a href="index.php?page=tambah" class="btn btn-primary mb-3">Tambah Data</a>
        <?php endif; ?>
        ...
        <footer class="pt-4 my-md-4 pt-md-3 border-top">
            <div class="row">
                <div class="col-12 col-md center">
                    &copy; 2024 - <a class="text-info" href="http://www.pnk.ac.id">Politeknik Negeri Kupang-Erwe</a>
                </div>
            </div>
        </footer>
    </div>
